...
chi_4d = {}
chi_2d = {}
chi4_FRMC_lin = np.zeros((len(beta),len(BnG),len(nb_MAGCAMB)))
chi2_FRMC_lin = np.zeros((len(beta),len(BnG),len(nb_MAGCAMB)))
chi4_FRMC_log = np.zeros((len(beta),len(BnG),len(nb_MAGCAMB)))
chi2_FRMC_log = np.zeros((len(beta),len(BnG),len(nb_MAGCAMB)))
chi_FRMC_lin = np.zeros((len(beta),len(BnG),len(nb_MAGCAMB)))
chi_FRMC_log = np.zeros((len(beta),len(BnG),len(nb_MAGCAMB)))
...
for bb in range(len(beta)):
    for gg in range(len(BnG)):
	    ...
	    #embed()
            ...
            #chi4_lin = np.sum(((FR_BB_lin-clbblens)/sig_clbb)**2.)*10.
            #chi2_lin = np.sum((FR_AA_lin_del10/sig_claa_lin10)**2.)*10.+np.sum((FR_AA_lin_del100/sig_claa_lin100)**2.)*100.
            #chi4_log = np.sum(((FR_BB_log-clbblens)/sig_clbb)**2.)*10.
            #chi2_log = np.sum((FR_AA_log_del10/sig_claa_log10)**2.)*10.+np.sum((FR_AA_log_del100/sig_claa_log100)**2.)*100.      
...
x_lin,y_lin,z_lin = argmin_3d(chi_FRMC_lin,len(beta),len(BnG),len(nb_MAGCAMB))
x_log,y_log,z_log = argmin_3d(chi_FRMC_log,len(beta),len(BnG),len(nb_MAGCAMB))
...
MC_FR_lin = vec_lin+tens_lin
MC_FR_log = vec_log+tens_log

num_r_lin = np.sum((abs(MC_FR_lin-clbblens)*GW_R1/sig_clbb)**2.)*10.
#num_r_lin = np.sum(((MC_FR_lin)*GW_R1/sig_clbb)**2.)*10.
denom_r_lin =np.sum((GW_R1/sig_clbb)**2.)*10.
r_eff_lin1 = num_r_lin/denom_r_lin
beta_lin1 = beta[x_lin]
BnG_lin1 = BnG[y_lin]
nb_FR_lin1 = nb_MAGCAMB[z_lin] 

num_r_log = np.sum((abs(MC_FR_log-clbblens)*GW_R1/sig_clbb)**2.)*10.
#num_r_log = np.sum(((MC_FR_log)*GW_R1/sig_clbb)**2.)*10.
denom_r_log =np.sum((GW_R1/sig_clbb)**2.)*10.
r_eff_log1 = num_r_log/denom_r_log
beta_log1 = beta[x_log]
BnG_log1 = log_BnG[y_log]
nb_FR_log1 = nb_MAGCAMB[z_log] 
...
for bb in range(len(beta)):
    for gg in range(len(BnG)):
	    ...
	    tens_log = MC_log[bb,gg,nn]['clBB_MC_tens'][18:4991:10]
            ...
            #sig_claa_log100 = delclaa(Nlaa_del100,FR_AA_log_del100,fsky,100.,Nlaa_ells_del100)	    
	    #embed()
            chi4_lin = np.sum(((abs(vec_lin+tens_lin-clbblens))/sig_clbb)**2.)*10.
            #chi2_lin = np.sum((FR_AA_lin_del10/sig_claa_lin10)**2.)*10.+np.sum((FR_AA_lin_del100/sig_claa_lin100)**2.)*100.
            chi4_log = np.sum(((abs(vec_log+tens_log-clbblens))/sig_clbb)**2.)*10.
            #chi2_log = np.sum((FR_AA_log_del10/sig_claa_log10)**2.)*10.+np.sum((FR_AA_log_del100/sig_claa_log100)**2.)*100.
...
#num_r_lin = np.sum(((MC_FR_lin)*GW_R1/sig_clbb)**2.)*10.
denom_r_lin =np.sum((GW_R1/sig_clbb)**2.)*10.
r_eff_lin2 = num_r_lin/denom_r_lin
beta_lin2 = beta[x_lin]
BnG_lin2 = BnG[y_lin]
nb_FR_lin2 = nb_MAGCAMB[z_lin] 

num_r_log = np.sum((abs(MC_FR_log-clbblens)*GW_R1/sig_clbb)**2.)*10.
#num_r_log = np.sum(((MC_FR_log)*GW_R1/sig_clbb)**2.)*10.
denom_r_log =np.sum((GW_R1/sig_clbb)**2.)*10.
r_eff_log2 = num_r_log/denom_r_log
beta_log2 = beta[x_log]
BnG_log2 = log_BnG[y_log]
nb_FR_log2 = nb_MAGCAMB[z_log] 
...
#num_r_lin = np.sum(((MC_FR_lin)*GW_R1/sig_clbb)**2.)*10.
denom_r_lin =np.sum((GW_R1/sig_clbb)**2.)*10.
r_eff_lin3 = num_r_lin/denom_r_lin
beta_lin3 = beta[x_lin]
BnG_lin3 = BnG[y_lin]
nb_FR_lin3 = nb_MAGCAMB[z_lin] 

num_r_log = np.sum((abs(MC_FR_log-clbblens)*GW_R1/sig_clbb)**2.)*10.
#num_r_log = np.sum(((MC_FR_log)*GW_R1/sig_clbb)**2.)*10.
denom_r_log =np.sum((GW_R1/sig_clbb)**2.)*10.
r_eff_log3 = num_r_log/denom_r_log
beta_log3 = beta[x_log]
BnG_log3 = log_BnG[y_log]
nb_FR_log3 = nb_MAGCAMB[z_log] 
...
#num_r_lin = np.sum(((MC_FR_lin)*GW_R1/sig_clbb)**2.)*10.
denom_r_lin =np.sum((GW_R1/sig_clbb)**2.)*10.
r_eff_lin4 = num_r_lin/denom_r_lin
beta_lin4 = beta[x_lin]
BnG_lin4 = BnG[y_lin]
nb_FR_lin4 = nb_MAGCAMB[z_lin] 

num_r_log = np.sum((abs(MC_FR_log-clbblens)*GW_R1/sig_clbb)**2.)*10.
#num_r_log = np.sum(((MC_FR_log)*GW_R1/sig_clbb)**2.)*10.
denom_r_log =np.sum((GW_R1/sig_clbb)**2.)*10.
r_eff_log4 = num_r_log/denom_r_log
beta_log4 = beta[x_log]
BnG_log4 = log_BnG[y_log]
nb_FR_log4 = nb_MAGCAMB[z_log] 

xdata = np.arange(0,400)[20:201:10]
ydata = abs(MC_FR_lin-clbblens)
...
r1,cov1 = curve_fit(clbbr_func,xdata,ydata,10E-4,sig_clbb)
r1 = r1[0]

xdata1 = xdata[0:9]
ydata1 = ydata[0:9]
r2,cov2 = curve_fit(clbbr_func,xdata1,ydata1,10E-4,sig_clbb[0:9])
